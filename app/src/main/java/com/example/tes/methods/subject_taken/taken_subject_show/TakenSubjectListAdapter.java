...
import com.example.tes.database.TakenSubjectQueryImplementation;
import com.example.tes.methods.subject_taken.TakenSubjectCrudListener;
...
public class TakenSubjectListAdapter extends RecyclerView.Adapter<TakenSubjectViewHolder> {
    ...
    public TakenSubjectViewHolder onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
        View view = LayoutInflater.from(context).inflate(R.layout.item_subject_taken, parent, false);
