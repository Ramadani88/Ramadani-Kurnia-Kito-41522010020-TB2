package com.example.tes.methods.subject.subject_list;
...
import com.example.tes.database.SubjectQueryImplementation;
import com.example.tes.methods.subject.SubjectCrudListener;
import com.example.tes.methods.subject.subject_update.*;
    ...
    public void onBindViewHolder(@NonNull SubjectViewHolder holder, int position) {
        ...
        holder.editIcon.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                SubjectUpdate dialogFragment = SubjectUpdate.newInstance(subject, "Update Subject", new SubjectCrudListener() {
                    @Override
